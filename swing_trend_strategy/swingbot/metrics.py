...
Beyond the standard toolkit, this includes expectancy (win_rate * avg_win -
loss_rate * avg_loss) and average holding period, since the research behind
this strategy specifically warns that win rate alone doesn't establish
profitability -- average win/loss size is what determines expectancy.
"""
