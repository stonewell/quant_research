...
### 第 2 步: 市场宽度与 10 日宽度冲力评估 (杠杆与仓位上限扩充)
...
* **IF (市场宽度 $\ge 30\%$ OR 10 日宽度冲力 $\ge 60\%$) AND 账户回撤 $< 10\%$**:
  * **动态现金动用激活**:
    * 若 10 日宽度冲力 $\ge 60\%$ (`crb_thrust_thresh = 0.60`): **超跌快速反弹快速通道** 直接赋最高多头因子 (1.0)。
    * 若常规 50 日宽度 $\ge 30\%$ (`crb_breadth_bull_thresh = 0.30`): 依宽度在 $30\%$ 至 $75\%$ 间平滑线性放大。
...
| **环境** | **市场宽度** | $\ge 30\%$ 位于50日线上 或 10日冲力 $\ge 60\%$ | **【多头激活动用】** 单票上限放宽至 $30\%$；股票总仓可配至 $80\%$。 |
