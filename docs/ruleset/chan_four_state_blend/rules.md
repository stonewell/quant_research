...
> **Strategy Identifier**: `chan_four_state_blend` (`ChanFourStateBlendStrategy`)  
...
**Chan Four-State Risk-Managed Blend Strategy** is a quantitative trading strategy designed for disciplined portfolio execution.
