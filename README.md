...
| `pipeline/research_strategy/` | Evaluates 45 quantitative trading strategies and exports factor research summaries | `pipeline/research_strategy/run_research_strategy.py` | `pipeline/research_strategy/README.md` |
