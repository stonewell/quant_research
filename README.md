...
- **`pipeline/`** -- the core research/backtest pipeline family (one shared `uv` environment):
  - `research_strategy/`: Researched quantitative trading strategies (39 TAA, timing, breakout, Chan structural, macro factor, and multi-strategy alpha book models) and factor summary exporter.
