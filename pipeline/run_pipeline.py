...
SCRIPTS = {
    "research_strategy": os.path.join(PIPELINE_DIR, "research_strategy", "run_research_strategy.py"),
    "instrument_selection": os.path.join(PIPELINE_DIR, "instrument_selection", "run_screener.py"),
    "pattern_mining": os.path.join(PIPELINE_DIR, "pattern_mining", "run_pattern_mining.py"),
    "strategy_generator": os.path.join(PIPELINE_DIR, "strategy_generator", "run_strategygen.py"),
    "backtester": os.path.join(REPO_ROOT, "backtester", "run_backtest.py"),
}
FACTOR_SUMMARY_PATH = os.path.join(PIPELINE_DIR, "research_strategy", "results", "factor_summary.json")
BASKET_PATH = os.path.join(PIPELINE_DIR, "instrument_selection", "results", "basket.json")
PATTERN_REPORT_PATH = os.path.join(PIPELINE_DIR, "pattern_mining", "results", "pattern_report.json")
STRATEGY_PATH = os.path.join(PIPELINE_DIR, "strategy_generator", "results", "strategy.json")
N_STEPS = 5
