...
def load_ohlcv(symbol: str, start: str, end: str, interval: str = "1d", use_cache: bool = True) -> pd.DataFrame:
    ...
    approximation of total return for a long-only backtest, since yfinance does
    not expose a separate unadjusted feed alongside dividends without extra calls).
    """
